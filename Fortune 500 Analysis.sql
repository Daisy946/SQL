...
# Which company in the Retail industry has the most revenue, and what's their revenue?
SELECT company_name, max(revenue)
FROM fortune_companies
WHERE industry='Retail';

# Which companies have healthcare benefits *and* at least 10 paid time off days?
SELECT company_name
FROM fortune_companies
